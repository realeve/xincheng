    ...
    <div class="content">
      ...
      <div class="welcome margin-top-20">
        <div v-if="!is_teacher">
          ...
          <p>
            感谢您的配合与支持，让我们携手同行，家校相互的理解和协作是孩子健康成长的基础！
          </p>

          <p>活动起止时间：6月19日07点至6月20日22:00（本周六晚上十点前截止）</p>
        </div>
        <div v-else>
          <p>尊敬的老师们：</p>
          <p>
            岁月不居，时节如流。一年之中有四分之三的时光我们与同事共同携手走过。这一学期，同事们工作表现如何？我们真诚希望您以客观、公正、实事求是的态度，对本学期所有的同事们给予满意度评价。
          </p>
          <p>
