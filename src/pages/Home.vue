    ...
    <div class="content">
      ...
      <div class="welcome margin-top-20">
        <div v-if="!is_teacher">
          ...
          <p>
            我们真诚希望您以客观、公正、实事求是的态度，对本学年（2020年9月-2021年6月）执教您孩子的所有老师们给予评价。
          </p>
          ...
          <p>活动起止时间：6月18日18:00-6月20日22:00(本周日晚上十点前截止）</p>
        </div>
        <div v-else>
          <p>尊敬的老师们：</p>
          <p>
          ...
          <p>活动起止时间：6月26日08:00-6月27日20:00</p>
        </div>
...
export default {
  ...
  mounted() {
    document.title = "龙小新城2020-2021学年度教师满意度测评问卷";
  },
};
</script>
